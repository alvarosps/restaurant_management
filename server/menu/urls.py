...
from menu.views.order_views import OrderListCreateView, CancelOrderView, UserOrderHistoryView, RefundOrderView, TableOrderView, AdvanceOrderStatusView, OrderAuditListView
...
urlpatterns = [
    ...
    path('orders/audits/', OrderAuditListView.as_view(), name='order-audits'),
